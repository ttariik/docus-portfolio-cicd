...
const projects: Project[] = [
  {
    ...
    description: 'E-commerce platform for baby tools and accessories. Built with modern web technologies, featuring secure payment processing, inventory management, and responsive design.',
  ...
  },
  {
    ...
    description: 'RESTful API for managing truck signage systems. Implements secure authentication, real-time updates, and comprehensive documentation for integration.',
    tags: ['API', 'REST', 'Backend', 'Security'],
    documentationLink: '/docs/projects/truck-signs-api',
    githubLink: 'https://github.com/ttariik/truck_signs_api/tree/feature/security-and-docker-enhancements',
  },
  {
    name: 'Juice Shop Meister',
    thumbnail: '/svg/project-thumbnails/CI-CD-Pipeline.svg',
    description: 'Security testing and vulnerability assessment tool based on OWASP Juice Shop. Automated security scanning and penetration testing framework.',
  ...
  },
  {
    ...
    description: 'Self-hosted Minecraft server with automated deployment, monitoring, and backup solutions. Containerized infrastructure with CI/CD pipeline integration.',
  ...
  },
  {
    ...
    description: 'WordPress hosting solution with automated deployment, SSL configuration, and performance optimization. Infrastructure as Code implementation.',
